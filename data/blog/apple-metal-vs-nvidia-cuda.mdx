...
images: ['/static/images/metal-memory-hierarchy.png']
draft: false
summary: "Notes on the Apple Silicon GPUs: Architecture, Memory Hierarchy, and the Metal Programming framework, and how it compares to NVIDIA CUDA."
---
...
![Metal Memory Hierarchy](/static/images/metal-memory-hierarchy.png "Metal Memory Hierarchy")

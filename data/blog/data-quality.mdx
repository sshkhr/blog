...
date: '2025-05-23'
tags: ['llm', 'pretraining', 'midtraining', 'posttraining', 'data-quality', 'synthetic-data', 'dpo']
images: ['/static/images/data-phi4.png']
draft: false
summary: "Notes on Microsoft phi-4 data pipeline for pre-training, 'mid-training', supervised fine-tuning and preference optimization"
---
...
>
> **Over half of the pre-training data (40% for Synthetic + 15% for Web rewrites) was not human generated data - instead it was generated from other LLMs with a lot of expert curation 🤯** Compare this to the [Llama-2 13B model](https://arxiv.org/abs/2307.09288) of a similar size which come out a year before phi-4, and was trained on a similar order of real world data (2B tokens) - **but had 0% synthetic training data!**

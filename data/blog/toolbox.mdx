...
<div className="-mx-2 flex flex-wrap justify-center overflow-hidden xl:-mx-2">
  <div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:w-3/4 xl:px-2">
    ![arXiv redirector](/static/images/arxiv-redirector-banner.jpg "arXiv redirector")
  </div>
</div>
...
<div className="-mx-2 flex flex-wrap justify-center overflow-hidden xl:-mx-2">
  <div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:w-3/4 xl:px-2">
    ![this blog](/static/images/shashankStack.png "this blog")
  </div>
</div>
...
<div className="-mx-2 flex flex-wrap justify-center overflow-hidden xl:-mx-2">
  <div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:w-3/4 xl:px-2">
    ![DeepLearning.AI companion website](/static/images/dlai-companion.png "DeepLearning.AI companion website")
  </div>
</div>
...
<div className="-mx-2 flex flex-wrap justify-center overflow-hidden xl:-mx-2">
  <div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:w-3/4 xl:px-2">
    ![MLSS Deadline countdown](/static/images/awesome-MLSS.png "MLSS Deadline countdown")
  </div>
</div>
